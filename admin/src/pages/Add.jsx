  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
          ...
          <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='กรอกชื่อสินค้า' required/>
        </div>

        <div className='w-full'>
          <p className='mb-2'>คำอธิบายสินค้า</p>
          <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='กรอกคำอธิบายสินค้า' required/>
        </div>
        ...
        <div className='flex gap-2 mt-2'>
          ...
          <label className='cursor-pointer' htmlFor="bestseller">เพิ่มในสินค้าขายดี</label>
        </div>
